        ...
        <div class="row">
            <div class="col-lg-6 mx-auto mb-4">
                <div class="section-title text-center ">
                    <h3 class="top-c-sep">My Friends List</h3>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="career-search mb-60">
                    ...
                    <div class="filter-result">
                        ...
                        @if ($actor->Friends && count($actor->Friends) > 0)
                            <p class="mb-30 ff-montserrat">Total Friends : {{ count($actor->Friends) }}</p>
                            @foreach ($actor->Friends as $item)
                                ...
                                <div class="job-box d-md-flex align-items-center justify-content-between mb-30">
                                    ...
                                    <div class="job-content">
                                        <button id="UnFriend{{ $i }}"
                                            class="btn d-block w-50 d-sm-inline-block btn-light border">UnFriend</button>
                                        <a href="{{ url('/home/Messages/' . $contact->_id) }}"
                                            class="btn d-block w-50 d-sm-inline-block btn-primary">Message</a>
                                ...
                                <script>
                                    jQuery(function($) {
                                        $("#UnFriend{{ $i }}").unbind().on("click", () => {
                                            alertify.confirm("Confirmation", 'Are you shure you want to unfriend this user ?',
                                                function() {
                                                    $.ajax({
                                                        type: "post",
                                                        url: "{{ url('/UnFriend') }}",
